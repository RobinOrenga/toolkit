...
{ 
   Copy-Item "C:\script\Support-TeamViewer.exe" "C:\Users\Public\Desktop"
...
{ 
	Write-Host
	Write-Host -ForegroundColor Red "NOTE: Création de l'utilisateur Administrateur"
	Write-Host
	
				Start-Sleep -Seconds 2
					
	New-LocalUser -Name "Administrateur" -Description "Administrateur" -Verbose
	
				Start-Sleep -Seconds 2
				
	Add-LocalGroupMember -Group "Utilisateurs" -Member "Administrateur" -Verbose
	
				Start-Sleep -Seconds 2
				
	Add-LocalGroupMember -Group "Administrateurs" -Member "Administrateur" -Verbose
}
...
$choixexe=Read-Host " Votre Choix "
	...
	{
    $Desinstall365 = o15-ctrremove.diagcab
